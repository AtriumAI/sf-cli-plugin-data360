...
export default class Data360TransformDelete extends CrudDeleteCommand {
  public static readonly summary = 'Delete Data 360 transform.';
  public static readonly examples = ['$ sf data360 transform delete --target-org myorg'];
