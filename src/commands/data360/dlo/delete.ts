...
export default class Data360DloDelete extends CrudDeleteCommand {
  public static readonly summary = 'Delete Data 360 dlo.';
  public static readonly examples = ['$ sf data360 dlo delete --target-org myorg'];
