...
export default class Data360DocaiConfigDelete extends CrudDeleteCommand {
  public static readonly summary = 'Config delete Data 360 docai.';
  public static readonly examples = ['$ sf data360 docai config-delete --target-org myorg'];
