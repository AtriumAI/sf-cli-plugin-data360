...
export default class Data360DocaiConfigGet extends CrudActionCommand {
  public static readonly summary = 'Config get Data 360 docai.';
  public static readonly examples = ['$ sf data360 docai config-get --target-org myorg'];
