...
export default class Data360DmoMappingDelete extends CrudDeleteCommand {
  public static readonly summary = 'Mapping delete Data 360 dmo.';
  public static readonly examples = ['$ sf data360 dmo mapping-delete --target-org myorg'];
