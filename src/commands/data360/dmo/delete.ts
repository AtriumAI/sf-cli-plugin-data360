...
export default class Data360DmoDelete extends CrudDeleteCommand {
  public static readonly summary = 'Delete Data 360 dmo.';
  public static readonly examples = ['$ sf data360 dmo delete --target-org myorg'];
